      ...
      <Stack flex={1} p={3} gap={3} overflow="hidden">
          ...
          {tabs.map((tab, idx) => (
            ...
            >
              ...
              <Stack gap={0.5} overflow="hidden" flex={1}>
                ...
                <Typography fontSize={12} color="#AAB0BC" overflow="hidden" whiteSpace="nowrap" textOverflow="ellipsis">
                  {tab.text}
                </Typography>
              </Stack>
            </Stack>
        ...
        <Stack direction="row" gap={3} justifyContent="space-between" alignItems="flex-start">
          ...
          <Stack direction="row" gap={1}>
            ...
            >
              <Typography fontSize={14} color={tabs.findIndex(tab => tab.value === activeTab) === tabs.length - 1 && '#9a9aa4'}>
                Next
              </Typography>
            </ButtonBase>
          </Stack>
            ...
            <Stack gap={3} maxWidth={650}>
              <Box>
                <Grid spacing={3} container>
                  ...
                  <Grid xs={6} item>
                    <Box position="relative" height="100%" display="flex" alignItems="flex-end" pb={0.5}>
              ...
              <Stack gap={1}>
                ...
                <Typography fontSize={12} color="#AAB0BC">
                  Assign to one or more groups to help manage your assets. o Edit Groups to go Settings &gt; Groups.
                </Typography>
              </Stack>
              <Stack gap={1}>
                ...
                >
                  <Stack px={2} ml={-2}>
                    <Stack direction="row" gap={3} maxWidth={300} justifyContent="space-between" alignItems="center">
                      <FormControlLabel
                    ...
                    <Stack direction="row" gap={3} maxWidth={250} justifyContent="space-between" alignItems="center">
                      <FormControlLabel
                ...
                <Stack gap={3} flex={1}>
                  <Stack gap={1}>
                    ...
                    <Typography fontSize={14}>
                      Manage device billing status. hen billing is disabled location and sensor data will not update.
                    </Typography>
                  </Stack>
                  <Box height="1px" bgcolor="#E2E2EA" />
                  <Stack gap={2}>
