        ...
        <Stack pl={3} flex={1}>
          ...
          >
            ...
            {activeTab === 'asset-configuration' && (
              <>
                <Box mb={4}>
                  <Tabs data={configurationTabs} activeTab={configurationTab} setActiveTab={handleChangeConfigurationTab} />
                </Box>
          ...
          {activeTab === 'users' && (
            <Stack
              ...
              position="relative"
            >
              <DefaultDataGrid columns={usersColumns} rows={usersRows} onRowClick={() => setUserDetailsModal(true)} />
            </Stack>
          )}
          {activeTab === 'groups' && (
            <Stack
              ...
              position="relative"
            >
              <DefaultDataGrid columns={groupsColumns} rows={groupsRows} onRowClick={() => setGroupDetailsModal(true)} />
            </Stack>
          )}
          {activeTab === 'asset-configuration' && configurationTab === 'categories' && (
            <Stack
              ...
              position="relative"
            >
              <DefaultDataGrid columns={categoriesColumns} rows={categoriesRows} onRowClick={() => setAssetCategoryModal(true)} />
            </Stack>
          )}
          {activeTab === 'asset-configuration' && configurationTab === 'types' && (
            <Stack
