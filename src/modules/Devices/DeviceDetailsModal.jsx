    ...
    <Stack gap={3}>
      ...
      <Stack gap={3} maxWidth={400}>
        ...
        {activeTab === tabs[1].value && (
          <>
            <DefaultSelect defaultValue="6 Hours" name="deviceDetails.expiration" helperText="Select Expiration" />
        ...
        {activeTab === tabs[2].value && (
          <>
            <DefaultSelect defaultValue="6 Hours" name="deviceDetails.interval" helperText="Select Reporting Interval" />
            <Typography fontSize={14} color="#A0A3A6">
              * Higher intervals will reduce battery life.
            </Typography>
            <Box
