        ...
        <Stack display="inline-flex" direction="row" borderBottom="1px solid #E1E3E8">
          {data?.map((item, idx) => {
            ...
            return (
              ...
              >
                <Typography fontSize={14} fontWeight={isActive ? 700 : 400} color={isActive ? 'secondary.main' : 'primary.main'}>
                  {item.title}
                </Typography>
                {isActive && (
                  <Box width="100%" height={3} bgcolor="secondary.main" position="absolute" bottom={0} left={0} />
                )}
              </Stack>
            )
          })}
